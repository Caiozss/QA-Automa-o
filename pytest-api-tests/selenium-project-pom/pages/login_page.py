...
class LoginPage(BasePage):
    ...
    def __init__(self):
        ...
        self.error_message_login = (By.XPATH, "//*[@id='login_button_container']/div/form/div[3]/h3")
    ...
    def verificar_texto_mensagem_erro_login(self, texto_esperado):
        ...
        assert texto_encontrado == texto_esperado, f"O texto encontrado foi '{texto_encontrado}' , mas era esperado o '{texto_esperado}'."
